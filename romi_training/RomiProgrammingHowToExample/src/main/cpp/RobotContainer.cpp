...
constexpr int kDriveForwardBtn = 3; 
...
void RobotContainer::ConfigureButtonBindings() {
  ...
  frc2::JoystickButton driveForwardBtn(&m_driverController, kDriveForwardBtn);
  driveForwardBtn.WhenHeld(DriveForwardCmd(&m_drivetrainSub));
}
